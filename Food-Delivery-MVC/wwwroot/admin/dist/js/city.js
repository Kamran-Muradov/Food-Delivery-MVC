            ...
            let data = JSON.stringify(
                {
                    ...
                    countryId: $('#form-create #countries').val()
                })
                ...
                error: function (xhr, status, error) {
                    ...
                    if (xhr.status == 409) {
                        ...
                        Swal.fire({
                            icon: "error",
                            title: "Oops...",
                            text: "City with this name already exists",
                        });
                    } else {
                        $("#form-create #create-btn").removeClass("d-none")
                        $("#form-create #loading-create-btn").addClass("d-none")
        ...
        submitHandler: function (form) {
            ...
            let data = JSON.stringify(
                {
                    ...
                    countryId: $('#table-area #modal-edit #countries').val()
                })
            ...
            $.ajax({
                ...
                success: function () {
                    ...
                    let country = $('#table-area #modal-edit #countries option:selected').html()
                    row.empty()
                    row.html(
                        `<td class="sort-name">${name}</td>
                         <td class="sort-name">${country}</td>
    ...
    function updateTable(response) {
        ...
        $.each(response.datas, function (index, item) {
            ...
            html += `<tr data-id="${item.id}">
                                    ...
                                    <td class="sort-name">${item.country}</td>
