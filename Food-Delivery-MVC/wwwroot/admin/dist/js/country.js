$(function () {
    ...
    $("#form-create").validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: 'https://localhost:7247/api/admin/country/create',
                method: 'POST',
                headers: {
    ...
    $(document).on('click', '#table-area .table-tbody .btn-warning', function (e) {
        ...
        $.ajax({
            type: "GET",
            url: `https://localhost:7247/api/admin/country/getbyid/${id}`,
            headers: {
                'Authorization': header
            },
            dataType: 'json',
    ...
    $("#form-edit").validate({
        ...
        submitHandler: function (form) {
            ...
            $.ajax({
                url: `https://localhost:7247/api/admin/country/edit/${id}`,
                method: 'PUT',
                headers: {
                    'Authorization': header
                },
    ...
    $(document).on("click", "#table-area .yes-btn", function () {
        ...
        $.ajax({
            type: "DELETE",
            url: `https://localhost:7247/api/admin/country/Delete?id=${id}`,
            headers: {
                'Authorization': header
            },
            success: function (response) {
    ...
    function getPaginatedDatas(page) {
        return Promise.resolve($.ajax({
            ...
            url: `https://localhost:7247/api/admin/country/GetPaginateDatas?page=${page}&take=5`,
            dataType: 'json',
            error: function (xhr, status, error) {
                $('#modal-small').modal('hide');
                $(".page-loader").addClass("d-none")
